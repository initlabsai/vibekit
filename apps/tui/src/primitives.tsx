/** The UI primitives every screen and card is built from: Frame, Header, Fact, Button, … */
import { breath } from './theme.js'
...
export function LiveDot({ live }: { live: 'probing' | boolean }) {
