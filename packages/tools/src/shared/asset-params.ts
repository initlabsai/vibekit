import { indexerSemaphore, type ToolContext } from '@initlabs/vibekit-core'
...
function apply(transactions: FormattedTransaction[], params: Map<number, AssetParams | null>): void {
  for (const tx of transactions) {
