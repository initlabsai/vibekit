...
import { lookupBlock } from '../src/network/handlers/block.js'
import { searchBlockHeaders } from '../src/network/handlers/block-headers.js'
import { getNetworkStatus } from '../src/network/handlers/status.js'
