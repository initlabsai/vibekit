 ...
 *
 * Security posture (docs/DESIGN.md §5): HTTP deployments default to compose
 * mode. Passing mode 'execute' here is an explicit self-host opt-in — the
 * deployer must put auth in front of the handler.
 */
