...
export const formattedTransactionSchema = z.object({
  ...
  applicationLabel: z
    .string()
    .optional()
    .describe('Known protocol contract; absent means unknown app — say so, never guess'),
  onCompletion: z.string().optional(),
  applicationArgs: z
    .array(z.string())
    .optional()
    .describe('Base64 application-args, selector first'),
...
export function transactionQueryOf(
  args: TransactionQuery & { address?: string },
