...
describe('normalizeAppSpec', () => {
  ...
  test('ARC-56 keeps named state keys and bare actions; other formats have neither', () => {
    const spec = normalizeAppSpec(
      JSON.stringify({
        ...
        state: {
          ...
          keys: {
            global: {
              count: { keyType: 'AVMString', valueType: 'uint64', key: 'Y291bnQ=', desc: 'hits' },
            },
            local: {},
            box: {
              greeting: { keyType: 'AVMString', valueType: 'AVMString', key: 'Z3JlZXRpbmc=' },
            },
          },
        },
    ...
    expect(spec.stateKeys).toEqual({
      global: {
        count: { keyType: 'AVMString', valueType: 'uint64', key: 'Y291bnQ=', description: 'hits' },
      },
      local: {},
